...
const detectionPanels = [
  ...
  { id: "adaf", task: "ALS/LiDAR archaeological feature detection", mediaKind: "video", media: "/reference-videos/foundation-potsherds.mp4", mediaLabel: "REFERENCE VIDEO · real airborne LiDAR archaeological landscape", actualOutput: false, detects: "Terrain anomalies and archaeological features in ALS-derived rasters.", output: "Feature detections from the ADAF upstream inference path.", evidence: "Input-gated: requires ALS/LiDAR GeoTIFF", image: "", source: "https://github.com/EarthObservation/adaf" },
  { id: "arran", task: "Archaeology benchmark scoring", mediaKind: "video", media: "/reference-videos/foundation-potsherds.mp4", mediaLabel: "REFERENCE VIDEO · real Scottish hillfort landscape", actualOutput: false, detects: "Not a detector: compares predictions against annotated Arran archaeological data.", output: "IoU matches, true positives, false positives, false negatives, precision, and recall.", evidence: "Benchmark artifact, not an image detector", image: "", source: "https://github.com/ickramer/Arran" },
  { id: "simulated-training-data", task: "Synthetic archaeological object generation", mediaKind: "video", media: "/reference-videos/foundation-potsherds.mp4", mediaLabel: "REFERENCE VIDEO · real terrain archaeology / LiDAR context", actualOutput: false, detects: "Not a detector: generates terrain/object training examples from DEM and stream vectors.", output: "Masks, modified raster, and vector annotations for training.", evidence: "Generated training artifact, not model inference", image: "", source: "https://github.com/NMC-CRS/simulated-training-data-for-archaeological-site-detection" },
  { id: "uav-thermal-person-geolocation", task: "People in thermal video + geolocation", mediaKind: "video", media: "/reference-videos/drone-tracker.mp4", mediaLabel: "REFERENCE VIDEO · real thermal drone person search", actualOutput: false, detects: "People in thermal frames, then projects detections to latitude/longitude using DJI SRT telemetry.", output: "Per-frame person boxes plus geographic coordinates.", evidence: "Requires thermal video and matching SRT", image: "", source: "https://github.com/Gruzver/uav-thermal-person-geolocation" },
