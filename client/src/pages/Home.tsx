...
const demoSpecs: Record<string, { input: string; detects: string; mode: string; ready: boolean; source: string }> = {
  ...
  "aerial-thermal-detection": { input: "Thermal video", detects: "Thermal people/objects with YOLO/RT-DETR", mode: "Needs thermal", ready: false, source: "https://huggingface.co/collections/Kiuyha/aerial-thermal-sar-detection" },
  "aerial-thermal-sar-detection-demo": { input: "Thermal image/video", detects: "Thermal SAR person detection", mode: "Needs thermal", ready: false, source: "https://huggingface.co/collections/Kiuyha/aerial-thermal-sar-detection" },
  ...
  "drone-control-monitoring-system": { input: "MAVLink / telemetry log", detects: "Flight/telemetry events; not video ML", mode: "Telemetry", ready: false, source: "https://github.com/thuyminh2112/Drone-control-monitoring-system" },
};
