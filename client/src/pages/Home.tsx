...
const detectionPanels = [
  ...
  { id: "simulated-training-data", task: "Synthetic archaeological object generation", mediaKind: "video", media: "/reference-videos/foundation-potsherds.mp4", mediaLabel: "REFERENCE VIDEO · real terrain archaeology / LiDAR context", detects: "Not a detector: generates terrain/object training examples from DEM and stream vectors.", output: "Masks, modified raster, and vector annotations for training.", evidence: "Generated training artifact, not model inference", image: "", source: "https://github.com/NMC-CRS/simulated-training-data-for-archaeological-site-detection" },
  { id: "uav-thermal-person-geolocation", task: "People in thermal video + geolocation", mediaKind: "video", media: "/reference-videos/drone-tracker.mp4", mediaLabel: "REFERENCE VIDEO · real thermal drone person search", detects: "People in thermal frames, then projects detections to latitude/longitude using DJI SRT telemetry.", output: "Per-frame person boxes plus geographic coordinates.", evidence: "Requires thermal video and matching SRT", image: "", source: "https://github.com/Gruzver/uav-thermal-person-geolocation" },
