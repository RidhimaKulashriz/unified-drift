...
const detectionPanels = [
  { id: "mustatil", task: "Archaeological site / mustatil detection", mediaKind: "image", media: "/reference/mustatil.jpg", mediaLabel: "REFERENCE EXAMPLE · real archaeological mustatil landscape", detects: "Archaeological structures and candidate sites in satellite or GeoTIFF imagery.", output: "YOLO class, confidence, and pixel bounding box.", evidence: "Input-gated: requires a site image or GeoTIFF", image: "", source: "https://github.com/tarekwasfy01/Mustatil-YOLO-AI-Model-Trainer-" },
  { id: "foundation-models-archaeology", task: "Archaeological feature discovery", mediaKind: "image", media: "/reference/foundation-hillfort.jpg", mediaLabel: "REFERENCE EXAMPLE · real hillfort landscape", detects: "Potential archaeological features using foundation-model and notebook workflows over satellite/LiDAR data.", output: "Notebook-emitted boxes or masks when the selected experiment produces them.", evidence: "Input-gated: notebook output only", image: "", source: "https://github.com/juergenlandauer/FoundationModelsArchaeology" },
  { id: "adaf", task: "ALS/LiDAR archaeological feature detection", mediaKind: "image", media: "/reference/adaf-lidar.jpg", mediaLabel: "REFERENCE EXAMPLE · real LiDAR archaeological terrain", detects: "Terrain anomalies and archaeological features in ALS-derived rasters.", output: "Feature detections from the ADAF upstream inference path.", evidence: "Input-gated: requires ALS/LiDAR GeoTIFF", image: "", source: "https://github.com/EarthObservation/adaf" },
  { id: "arran", task: "Archaeology benchmark scoring", mediaKind: "image", media: "/reference/arran-shieling.jpg", mediaLabel: "REFERENCE EXAMPLE · real Scottish archaeological structure", detects: "Not a detector: compares predictions against annotated Arran archaeological data.", output: "IoU matches, true positives, false positives, false negatives, precision, and recall.", evidence: "Benchmark artifact, not an image detector", image: "", source: "https://github.com/ickramer/Arran" },
  { id: "simulated-training-data", task: "Synthetic archaeological object generation", mediaKind: "image", media: "/reference/dem-lidar.jpg", mediaLabel: "REFERENCE EXAMPLE · real terrain/LiDAR landscape", detects: "Not a detector: generates terrain/object training examples from DEM and stream vectors.", output: "Masks, modified raster, and vector annotations for training.", evidence: "Generated training artifact, not model inference", image: "", source: "https://github.com/NMC-CRS/simulated-training-data-for-archaeological-site-detection" },
  { id: "uav-thermal-person-geolocation", task: "People in thermal video + geolocation", mediaKind: "image", media: "/reference/thermal-drone-rescue.jpg", mediaLabel: "REFERENCE EXAMPLE · real thermal-drone search-and-rescue scene", detects: "People in thermal frames, then projects detections to latitude/longitude using DJI SRT telemetry.", output: "Per-frame person boxes plus geographic coordinates.", evidence: "Requires thermal video and matching SRT", image: "", source: "https://github.com/Gruzver/uav-thermal-person-geolocation" },
  { id: "drone-tracker", task: "Objects and people with persistent tracks", mediaKind: "image", media: "/reference/thermal-person.jpg", mediaLabel: "REFERENCE EXAMPLE · real thermal person-search imagery", detects: "Objects in drone RGB video across the complete upload.", output: "Per-frame class, confidence, bounding box, and track ID.", evidence: "Full-video annotated MP4 from the worker", image: "", source: "https://github.com/Gruzver/drone-tracker" },
  { id: "aerial-thermal-detection", task: "People/objects in aerial thermal imagery", mediaKind: "image", media: "https://raw.githubusercontent.com/kiuyha/Aerial-Thermal-Detection-RT-DETRv2-and-YOLOv12/HEAD/RT-DETRv2/val_batch0_pred.jpg", mediaLabel: "REFERENCE EXAMPLE · real thermal aerial imagery", detects: "Thermal targets using the upstream RT-DETRv2 checkpoint.", output: "Per-frame thermal bounding boxes, class labels, and confidence.", evidence: "Official upstream annotated result sample", image: "https://raw.githubusercontent.com/kiuyha/Aerial-Thermal-Detection-RT-DETRv2-and-YOLOv12/HEAD/RT-DETRv2/val_batch0_pred.jpg", source: "https://github.com/kiuyha/Aerial-Thermal-Detection-RT-DETRv2-and-YOLOv12" },
  { id: "aerial-thermal-sar-detection-demo", task: "Thermal SAR person detection comparison", mediaKind: "image", media: "/reference/thermal-sar-search.jpg", mediaLabel: "REFERENCE EXAMPLE · real infrared search-and-rescue imagery", detects: "People/targets in thermal SAR imagery using YOLOv12 and RT-DETRv2.", output: "Two model-specific detection sets with boxes and confidence scores.", evidence: "Official upstream annotated result sample", image: "https://raw.githubusercontent.com/kiuyha/Aerial-Thermal-Detection-RT-DETRv2-and-YOLOv12/HEAD/YOLOv12/val_batch0_pred.jpg", source: "https://github.com/kiuyha/Aerial-Thermal-Detection-RT-DETRv2-and-YOLOv12" },
  { id: "rgbt-fusion-drone-sar", task: "RGB + thermal fused target detection", mediaKind: "image", media: "/reference/rgbt-drone-person.jpg", mediaLabel: "REFERENCE EXAMPLE · real RGB-T drone/person scene", detects: "Targets from synchronized RGB and thermal streams through an ONNX fusion model.", output: "Raw fused tensors; boxes only when the upstream schema decodes them.", evidence: "Output-gated: no boxes are invented", image: "", source: "https://github.com/hiungn/RGBT-Fusion-Drone-SAR" },
  { id: "ros2-disaster-robot-sim", task: "Disaster robot and sensor state", mediaKind: "image", media: "/reference/ros2-gazebo.jpg", mediaLabel: "REFERENCE EXAMPLE · real robotics/Gazebo scene", detects: "Not an ML detector: simulates robots, sensors, navigation, and disaster-world state.", output: "ROS2/Gazebo launch, robot, sensor, map, and collision artifacts.", evidence: "Simulation artifact, not a detection image", image: "", source: "https://github.com/newton-adhikari/ros2-disaster-robot-sim" },
  { id: "drone-control-monitoring-system", task: "Flight and telemetry event monitoring", mediaKind: "image", media: "https://raw.githubusercontent.com/thuyminh2112/Drone-control-monitoring-system/HEAD/docs/images/dashboard.png", mediaLabel: "REFERENCE EXAMPLE · real ground-station telemetry dashboard", detects: "Not a visual detector: processes MAVLink/telemetry events from a drone ground station.", output: "Flight state, telemetry events, and monitoring records.", evidence: "Telemetry artifact, not an image detector", image: "", source: "https://github.com/thuyminh2112/Drone-control-monitoring-system" },
];
